      ...
      <div className="h-full flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6">
          <div className="text-center max-w-sm">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full border border-emerald-500/30 bg-emerald-500/10 mb-6">
              <span className="text-3xl">✓</span>
            </div>
            <h2 className="font-display text-2xl text-card-white mb-3">No Misses to Replay</h2>
            <p className="font-body text-sm text-white/40 mb-8">
              Every count check was correct. Nothing to review.
            </p>
            <button
              onClick={onBack}
              className="rounded-xl border border-white/10 bg-white/[0.02] px-6 py-3 font-body text-sm text-white/40 hover:text-white/60 transition-all"
            >
              Back
            </button>
          </div>
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6">
        {isComplete && summary ? (
          ...
          <div className="max-w-sm w-full text-center">
            ...
            <h2 className="font-display text-3xl text-card-white mb-6">Correction Results</h2>
          ...
          <div className="max-w-sm w-full text-center" role="status" aria-live="polite">
            ...
            <h3 className={`font-display text-xl mb-2 ${lastResult.isCorrect ? 'text-emerald-400' : 'text-red-400'}`}>
          ...
          <div className="max-w-sm w-full">
            <div className="text-center mb-8">
              ...
              <p className="font-mono text-sm text-white/20 mb-6">
                Hand #{problem.handNumber}
              </p>

              <div className="mb-8">
                <div className="inline-flex flex-col items-center gap-2 rounded-xl border border-red-400/10 bg-red-400/[0.03] px-8 py-4">
                  <p className="font-body text-[10px] uppercase tracking-wider text-white/20">
                    Your previous answer
                  </p>
                  <p className="font-mono text-3xl font-bold text-red-400/40 line-through decoration-2">
